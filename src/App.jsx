...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body { background: #080a0f; color: #fff; font-family: 'Inter', system-ui, sans-serif; width: 100%; min-height: 100vh; }
    #root { width: 100%; }
...
const Hero = ({ onScrollTo }) => {
  ...
  return (
    <section ref={ref} style={{ width: "100%", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "space-between", position: "relative", paddingTop: 64 }}>
      {/* BG glow */}
...
const FeaturedWork = () => (
  <section id="work" style={{ width: "100%", padding: "100px 8% 0" }}>
    <div style={{ maxWidth: 860, margin: "0 auto" }}>
      ...
      {workData.map((w, i) => (
        <div key={w.title} style={{ position: "sticky", top: 72 + i * 18, zIndex: i + 1, marginBottom: i < workData.length - 1 ? 80 : 100 }}>
  ...
  return (
    <section id="services" style={{ width: "100%", padding: "100px 8%" }}>
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
        ...
        {services.map((s, i) => (
          <div key={s.num} style={{ position: "sticky", top: 72 + i * 24, zIndex: i + 1, marginBottom: i < services.length - 1 ? 80 : 100 }}>
    ...
    <div style={{ maxWidth: 760, margin: "0 auto" }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        {testimonials.map((t, i) => (
          <div key={t.name} style={{ position: "sticky", top: 72 + i * 24, zIndex: i + 1, marginBottom: i < testimonials.length - 1 ? 80 : 0 }}>
...
export default function App() {
  ...
  return (
    <>
      <GlobalStyles />
      <div style={{ width: "100%", background: "#080a0f", color: "#fff", fontFamily: "'Inter', system-ui, sans-serif", maxWidth: "100vw" }}>
